...
const JobCard = ({job}) => {
  ...
  return (
    <div className='border p-6 shadow rounded'>
        ...
        {/*dangerouslySetInnerHTML allows inserting raw HTML. */}
        ...
        <div className='mt-4 flex gap-4 text-sm'>
          ...
          <button onClick={()=> {navigate(`/apply-job/${job._id}`) ; scrollTo(0,0) }} className='text-black-500 border bg-gray-200 border-gray-500 rounded px-4 py-2'>Learn more</button>
        </div>
